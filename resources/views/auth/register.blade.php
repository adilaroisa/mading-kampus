        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-5">
                ...
                <div class="flex items-center bg-gray-50 border border-gray-300 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-teal-400 focus-within:border-teal-400 transition shadow-sm">
                    ...
                    <input id="email" class="block w-full border-none bg-transparent py-3 focus:ring-0 text-gray-700" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="contoh@email.com" />
                </div>
