        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center bg-gray-50 border border-gray-300 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-indigo-400 focus-within:border-indigo-400 transition shadow-sm">
                    ...
                    <x-password-input id="password" name="password" autocomplete="current-password" placeholder="••••••••" class="w-full" />
                </div>
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-sm font-bold text-teal-600 hover:text-teal-800 transition">
                        {{ __('Lupa kata sandi?') }}
                    </a>
                @endif
            </div>
